...
# def deleter(text):
#
#     spisochek = ['a', 'e', 'y', 'u', 'i', 'o', "A", 'E', 'O', 'U', 'I', 'Y']
#
#     if len(text) <= 10:
...
# def display(text): return print(text)
...
#     spisochek_3 = []
#
#     while True:                    # Цикл для первого ввода данных
#         try:
#             f_1 = int(input("Print your amount of numbers( >7, <30) - "))
#             if 7 <= + f_1 <= 30:
#                 break
#             elif 7 > f_1:
...
#
#     while True:
#         f_2 = input('Print numbers for generator (use "," or " " to separate numbers) - ')            # Цикл для другого ввода данных
#         list_of_numbers = []
#
#         try:
#             if " " in f_2 and "," in f_2:                                # Проверка на знаки между цифрами
#                 print('Print only " " or ","!')
#
#             elif ',' in f_2:
#                 stroki = f_2.split(',')
...
#
#                 if len(list_of_numbers) < 3:                 # проверка на достаточное количество чисел
#                     print('Not enough digits, type more!')
#                 else:
#                     break
#
#             elif " " in f_2:
...
#                 print('Not enough digits, type more!')
#
#         except:                              # Если написать что-то помимо чисел
#             print("Print only numbers!")
#
#     for i in range(f_1):                           # Генератор наших чисел
#         a = choice(list_of_numbers)
#         spisochek_3.append(str(a))
#     return "".join(spisochek_3)
#
#
